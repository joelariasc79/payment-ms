...
public class AppConfigMySql {
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://13.217.222.134:3306/paymentsdb"); // Update with your DB details
...
//    public DataSource dataSource(){
//        DriverManagerDataSource dataSource = new DriverManagerDataSource();
//        dataSource.setUrl("jdbc:mysql://localhost:3306/paymentsdb"); // Update with your DB details
//        dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        entityManagerFactory.setPackagesToScan("com.payment.ms.entity");
